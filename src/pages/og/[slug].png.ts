...
export const getStaticPaths: GetStaticPaths = async () => {
	...
	const publishedPosts = allPosts.filter((post) => !(post.data as any).draft);
...
export async function GET({
	...
	const pubDate = (post.data as any).published.toLocaleDateString("en-US", {
		year: "numeric",
		month: "short",
		day: "numeric",
	});
									...
									children: [
										...
										},
										{
											...
											props: {
												...
												children: (post.data as any).title,
											},
										},
									],
								},
